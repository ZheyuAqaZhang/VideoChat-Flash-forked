...
def dispatch_internvl2_forward(module):
...
def dispatch_internvl2_hico_forward(module):
    ...
    _dispatch_forward_fn(module, internvl2_hico_forward)
    return internvl2_hico_forward.__name__
...
DISPATCH_MAP = {
    ...
    'InternVLChatModel': dispatch_internvl2_forward,  # to support sp
    'InternVLChatModel_hico': dispatch_internvl2_hico_forward,  # to support sp
}
